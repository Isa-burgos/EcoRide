            ...
            <button class="search-trip-btn" type="button">
                <div class="search-trip-container">
                    ...
                    <div class="search-trip-direction">
                        ...
                        <div>
                            <p class="m-0 text-secondary text-start">Aujourd'hui, 1 passager</p>
                        </div>
                    </div>
                </div>
            </button>
        ...
        <div class="covoiturages-dashboard-content">
            <div class="recap-search">
                ...
                <div class="recap-search-trip text-primary">
                    ...
                    <span>Valence</span>
                    <span>:</span><br>
                    <span>5 trajets disponibles</span>
                </p>
                </div>
            </div>
                            ...
                            <div class="trip-card p-0">
                                <div class="trip-details-top">
                                    <div class="trip-details-left p-2">
                                        <div class="trip-hour">
                                            <span class="trip-depart">07:50</span>
                                            <span class="trip-duration">1h10</span>
                                            <span class="trip-arrival">09:00</span>
                                        </div>
                                        ...
                                        <div class="trip-place">
                                            <span class="trip-depart">Aubenas</span>
                                            <span class="trip-arrival">Valence</span>
                                        </div>
                                    </div>
                                    <div class="trip-details-right p-2">
                                        <div class="trip-price">
                                            <p class="m-0">5 <span>Crédits</span></p>
                                        </div>
                                        <div class="trip-passenger">
                                            <p class="m-0">1 <span>passager</span></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="trip-details-bottom">
                                    ...
                                    <div class="name-container">
                                        <div>
                                            <p class="text-secondary">Prénom</p>
                                        </div>
                                        <div class="rating">
                                            <div>
